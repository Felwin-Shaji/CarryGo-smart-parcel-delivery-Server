...
export class AdminProfileController implements IAdminProfileController {
    ...
    getAdminProfile = async (req: Request, res: Response, next: NextFunction): Promise<Response | void> => {
        try {
    ...
    editAdminProfile = async (req: Request, res: Response, next: NextFunction): Promise<Response | void> => {
        try {
    ...
    resetAdminPassword = async (req: Request, res: Response, next: NextFunction): Promise<Response | void> => {
        try {
