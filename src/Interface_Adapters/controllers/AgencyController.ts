...
import { IAgencyController } from "../../Application/interfaces/conytollers/agency.controller";
import { inject, injectable } from "tsyringe";
import { AgencyMapper } from "../../Application/Mappers/AgencyMapper";
import { IUploadAgencyKycFilesUseCase } from "../../Application/interfaces/useCase/Agency/UploadAgencyKycFilesUseCase";
import { ISaveAgencyKycUseCase } from "../../Application/interfaces/useCase/Agency/SaveAgencyKycUseCase";
import { IUpdateAgencyKycStatusUseCase } from "../../Application/interfaces/useCase/Agency/UpdateAgencyKycStatusUseCase";
...
export class AgencyController implements IAgencyController {
    ...
    submitKYC = async (req: Request, res: Response, next: NextFunction): Promise<Response | void> => {
        try {
            ...
            const agency = await this.updateStatus.execute(dto.agencyId);
